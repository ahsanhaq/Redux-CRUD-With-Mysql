      ...
      <div class="box box-default">
        ...
        <div class="box-body">
          <div class="row">
            ...
            <form action="<?= base_url('dashboard/upload_video')?>" method="post" enctype="multipart/form-data">
            <div class="col-md-4">
              ...
              <div class="form-group">
                <label>Video Title</label>
                  ...
                  <div class="col-sm-15">
                    <input type="text" class="form-control" id="inputEmail3" name="title" placeholder="Video Title" required>
                  </div>
              </div>
			  <div class="form-group">
