            ...
            <div class="col-md-6">
              ...
              <div class="form-group">
                <label>Name</label>
                  ...
                  <div class="col-sm-15">
                    <input type="text" class="form-control" id="inputEmail3" value="<?php echo $result[0]->fa_name;?>" name="fa_name" placeholder="Entrer Name" required>
			  ...
			  <div class="form-group">
                <label>Joining Date</label>
                  ...
                  <div class="col-sm-15">
                    <input type="date" class="form-control" id="inputEmail3" name="join_date" value="<?php echo $result[0]->join_date;?>" placeholder="Joining Date" required>
                  </div>
              </div>
			  <div class="form-group">
                <label>Address</label>
