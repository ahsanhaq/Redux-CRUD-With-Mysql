    ...
    <section class="content">
      ...
      <div class="box box-default">
        <div class="box-header with-border">
          <h3 class="box-title">Coupon User List</h3>
        ...
        <tbody>
			...
			<tr>
                ...
                <!--<td><?php echo $user->country?></td>
				 ...
				 <td>
				<a href="<?php echo base_url()?>dashboard/delete_coupon_freeuser/<?php echo $user->user_id?>" onclick="return checkDelete()"><button class="btn btn-danger btn-sm">Delete</button></a></td>
